...
class sms
{
    ...
    public static void main(String[] args){
        ...
        try
        {
            ...
            String query = "SELECT o.text, p.phoneNo FROM sendingsms o, phoneno p WHERE p.username = o.username AND o.Status =\"pending\"";
                ...
                try {
                    ...
                    for (Recipient recipient : response) {
                        ...
                        try
                        {
                            ...
                            // the mysql insert statement
                            String query1 = " update sendingsms SET Status ='success' WHERE Status ='pending'";
